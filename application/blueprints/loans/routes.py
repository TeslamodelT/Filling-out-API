...
from application.models import Loan, Book, db
from . import loans_bp
from application.blueprints.books.schemas import books_schema
...
@limiter.limit("10 per day") #limit request to 10 times per day
